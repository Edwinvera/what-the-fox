...
async function getFox() {
  ...
  let helloFren = `Hello fren! My name is ${inputFruit.value}y ${inputSmoosh.value}z. I hail from a far away land called ${inputColor.value} ${inputVaca.value}. I am your Spirit Fox.`
